		...
		<div id="footer_wrap">
			<div id="footer">
				...
				<div class="footer0">
					...
					<a href="/_innermall/using.php" target="_blank" class="enter">이용약관</a><span>|</span><a href="/_innermall/Policy.php" target="_blank" class="enter2">개인정보처리·취급방침</a><span>|</span><a href="/_innermall/eventadm/login.php?refer=hm" target="_blank">관리자</a>
				</div>
				<div class="footer1">
