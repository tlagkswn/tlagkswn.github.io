...
<!-- saved from url=(0040)http://www.varisonc.com/privateinfo.html -->
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko" class="mti-inactive"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>이용약관 및 개인정보취급방칩</title>
...
<div id="header">
		<h1><a href="#"><img src="img/logo.png" alt="logo" class="mainhead_img"/></a></h1><?php echo $w_edit_mainhead;?>
	
<!-- 		<span class="top_">임직원전용 몰</span> -->
		<span class="right_logo"><img src="img/right_logo.png" alt="right_logo" style="margin-top:45px"/></span>
	</div>
<div class="policy-c" style="width:1200px;margin:0 auto;">
	<article><p style="font-size:20px; margin:30px auto;text-align:center;">이용약관</p>
<p>
	</p>
<p>회원가입 전 반드시 이용약관을 읽어보시기 바랍니다.</p>
	<p><br>제 1조 (목적)</p>
<br><p><br>이 약관은 (주)TWKorea(전자상거래 사업자)가 운영하는 'twkmall.co.kr' 사이버몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>
	※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</p>
<br><p><br>제 2조 (정의)</p>
<br><ol>
<li>① “몰”이란 (주)TWKorea이 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
	...
	<li>"비회원"이라 함은 회원에 가입하지 않고 "몰"가 제공하는 서비스를 이용하는 자를 말합니다.</li>
	<li>④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.</li>
	</ol>
<p><br>제 3조 (약관 등의 명시와 설명 및 개정)</p>
<br><ol>
<li>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 'twkmall.co.kr' 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
...
<li>⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래 등에서의 소비자 보호지침 및 관계법령 또는 상관례에 따릅니다.</li>
	</article><article><p><br>제 4조 (서비스의 제공 및 변경)</p>
<br><ol>
...
<li>① “몰”은 컴퓨터 등 정보통신설비의 보수점검․교체 및 고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다.</li>
	...
	</ol></article><article><p><br>제 6조 (회원가입)</p>
<br><ol>
...
<li>① “몰”이 회원에 대한 통지를 하는 경우, 회원이 “몰”과 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.</li>
	...
	</ol></article><article><p><br>제9조(구매신청 및 개인정보 제공 동의 등) </p>
<br><p><br>① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. </p>
<br><ol>
...
<p><br>② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.)</p>
<br><p><br>③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.</p>
<br><p><br>제 10조 (구매계약의 성립)</p>
<br><ol>
...
<p><br>제 11조 (지급방법)</p>
<br><ol>
<li>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.<br>
	...
	8. 기타 전자적 지급 방법에 의한 대금 지급 등</li>

	<p><br>제12조(수신확인통지․구매신청 변경 및 취소)</p>
<br><ol>
...
<p><br>제 14조 (환급)</p>
<br><p><br>“몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</p>
<br><p><br>제 15조 (청약 철회 등)</p>
<br><ol>
...
</ol></article><article><p><br>제17조(개인정보보호)</p>
<br><ol>
...
<p><br>제 19조 (회원의 ID 및 비밀번호에 대한 의무)</p>
<br><ol>
...
<p><br>제 20조 (이용자의 의무)</p>
<br><p><br>이용자는 다음 행위를 하여서는 안됩니다.</p>
<br><ol>
...
</ol></article><article><p><br>제21조(연결“몰”과 피연결“몰” 간의 관계)</p>
<br><ol>
