...
<html lang="en">
 <head>
  ...
  <title>임직원전용 몰</title>
  <link rel="stylesheet" type="text/css" href="css/main_han_0.css">
		...
		<div class="con3_l">
			...
			<div class="con3_l_bottom">
				...
				?>
					...
					?>
						<span class="pp_linker" style="">
							<span class="pp_linker_in" style="">
								<a href="<?php echo $specialArr[$i]['wlink'.$j]?>" target="_blank" style="display:inline-block;width:100%;"><img src="<?php echo $specialArr[$i]['new_logo'.$j]?>" alt="location_off" /></a>
							</span>
							<a href="<?php echo $specialArr[$i]['wlink'.$j]?>" target="_blank" style="display:inline-block;width:100%">T.<?php echo $specialArr[$i]['wtel'.$j]?></a>
						</span>
					<?php
							}else{
					?>
