									...
									<ul class="estimate_applicant_comm_wrap">
										<li class="estimate_applicant_body0 estimate_applicant_comm dl_0">
											<dl>
												...
												<dd class="estimate_applicant_comm1"><input type="text" required name="city_fdate1[]" placeholder="출발일" class="date_picker cityna_1"/></dd>
												<dd class="estimate_applicant_comm2"><input type="text" required name="city_ftime1[]" placeholder="출발시간대" class="cityna_2"/></dd>
												<dd class="estimate_applicant_comm3">
													<input type="text" required name="city_sdate1[]" placeholder="도착일" class="date_picker cityna_1"/>	
												</dd>
												<dd class="estimate_applicant_comm4">
													<input type="text" name="city_etc1[]" required class="cityna_0" placeholder="도착시간대" >			
												</dd>
