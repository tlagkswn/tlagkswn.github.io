 ...
 <script type="text/javascript">
	...
	//others
		...
		$(".top_icons1").click(function(){
			window.open("/_innermall/eventadm/hmapi/hmlogin.php","hmLogin","top=200, left=200, width=450, height=320");
		...
		<div id="footer_wrap">
			<div id="footer">
				...
				<div class="footer0">
					...
					<a href="#" class="enter">이용약관</a><span>|</span><a href="#" class="enter2">개인정보처리·취급방침</a><span>|</span><a href="/_innermall/eventadm/login.php">관리자</a>
				</div>
				<div class="footer1">
