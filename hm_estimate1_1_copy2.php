...
<script type="text/javascript">
		//var aa= getElementById("aircost_max").value;
		//var aa = document.getElementById("aircost_max").value = "11";
		alert(11)
	...
	// add
			...
			var angular_num = $(".esti_right_table_bott1").index();
			//alert(angular_num)
	...
	<div id="esti_wrap" data-ng-app="">
		...
		<form method="post" name="recommend_air_form" action="eventadm/command/hm_trip_upload_data.php" id="esti_right2" class="esti_airChk" >
					...
					?>
						<ul class="esti_right_table_bott1">
							...
							<li class="esti_ul5">
								<dl>
									<dd>
										<input type="number" name="aircost[]" class="input_type4" placeholder="기본항공료" onchange="sumAirFee(this.value,0,0);" ng-model="quantity0"/>
									</dd>
									<dd>
										<input type="number" name="agencyfee[]" class="input_type4" placeholder="대행수수료" onchange="sumAirFee(0,this.value,0);" ng-model="price0"/>
									</dd>
									<dd>
					...
					?>
						<ul class="esti_right_table_bott1">
							...
							<li class="esti_ul5">
								<dl>
									<dd>
										<input type="number" name="aircost[]" value="<?php echo $aircost_arr[$i]?>" class="input_type4" placeholder="기본항공료" ng-model="quantity0"/>
									</dd>
									<dd>
										<input type="number" name="agencyfee[]" value="<?php echo $agencyfee_arr[$i]?>" class="input_type4" placeholder="대행수수료" ng-model="price0"/>
									</dd>
									<dd>
			...
			<div class="esti_right2_body estimate1Php_wrap">
					...
					<ul>
						<li>
							...
							<div class="esti_right2_body_float">
								...
								<div class="esti_right2_body_div">
									<input id="aircost_max" value="{{ quantity0 + price0 + quantity1 + price1 +quantity2 + price2 }}" maxlength="11" type="number" class="input_type1"/> KRW
								</div>
							</div>
						</li>
						<li>
